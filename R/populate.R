...
#' @param fun A [function] with at least one argument, which will be called to compute the value of a binding.
#'   The function will be called with the binding name as first argument (unnamed),
