...
For illustration, the `append_random()` function is used, which appends a separator (a dash by default) and a random letter to its input, and talks about it, too.
